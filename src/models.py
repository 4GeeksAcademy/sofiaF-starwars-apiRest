...
class User(db.Model):
    ...
    favorites_vehicles = db.relationship('FavoritesVehicles', backref='user', lazy=True) #Se definen relaciones entre las tablas utilizando la función relationship de SQLAlchemy.
